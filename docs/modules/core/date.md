...
# 两个时间段是否重叠
DateUtil.is_overlap(date(2024, 1, 1), date(2024, 6, 30), date(2024, 3, 1), date(2024, 12, 31))  # True
...
# 判断日期是否在范围内（含边界）
DateUtil.range_contains(datetime(2024, 1, 1), datetime(2024, 12, 31), datetime(2024, 6, 15))  # True
